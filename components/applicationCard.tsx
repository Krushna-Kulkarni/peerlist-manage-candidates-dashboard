...
const ApplicationCard: React.FC<ApplicationCardProps> = ({ application }) => {
  ...
  return (
    <>
      <div className=" flex flex-col gap-2 px-3 py-3 justify-between border-2 border-[#E1E4E8] rounded-lg  min-w-92 w-96 h-auto mb-3 ">
        <>
          ...
          (currentStatus === "Shortlisted" || currentStatus === "Rejected") ? (
            ...
            <div>
              <div className="text-[10px] font-light text-[#6A737D]">
                Contact
              </div>
              <div className="flex flex-col ">
